...
plt.ylabel("$C_L$ [-]")
plt.title(r' $ C_L - \alpha $ curve for the 3D case')
plt.grid()
...
plt.xlabel(r' $\alpha$ [deg]')
plt.ylabel("$C_M$ [-]")
plt.title(r' $C_M - \alpha$ curve for the 3D case')
plt.grid()
...
plt.xlabel("$C_D$ [-]")
plt.ylabel("$C_L$ [-]")
plt.title("$C_D - C_L $ curve for the 3D case")
plt.grid()
...
plt.xlabel(r' $\alpha$ [deg]')
plt.ylabel("$C_D$ [-]")
plt.title(r' $C_D - \alpha$ curve for the 3D case')
plt.grid()
...
plt.xlabel(r'$ \alpha [deg]')
plt.ylabel("$C_l$ [-]")
plt.title(r' $ C_l - \alpha$ curve for the 2D case')
plt.grid()
...
plt.xlabel(r' $\alpha$ [deg]')
plt.ylabel("$C_d$ [-]")
plt.title(r' $C_d - \alpha$ curve for the 2D case')
plt.grid()
...
plt.xlabel("$C_d$ [-]")
plt.ylabel("$C_l$ [-]")
plt.title("$C_d - C_l $ curve for the 2D case")
plt.grid()
...
plt.xlabel(r' $\alpha$ [deg]')
plt.ylabel("$C_m$ [-]")
plt.title(r'$C_m - \alpha$ curve for the 2D case')
plt.grid()
